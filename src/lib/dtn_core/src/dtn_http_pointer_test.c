...
int test_dtn_http_pointer_parse_version() {
    ...
    testrun(DTN_HTTP_PARSER_ERROR ==
            dtn_http_pointer_parse_version(NULL, 0, NULL));
    testrun(DTN_HTTP_PARSER_ERROR ==
...
int test_dtn_http_pointer_parse_status_line() {
    ...
    testrun(DTN_HTTP_PARSER_ERROR ==
            dtn_http_pointer_parse_status_line((uint8_t *)buf, len, NULL, NULL,
                                               NULL));
    testrun(DTN_HTTP_PARSER_ERROR == dtn_http_pointer_parse_status_line(
                                         NULL, len, &line, &version, NULL));
    testrun(DTN_HTTP_PARSER_ERROR ==
            dtn_http_pointer_parse_status_line((uint8_t *)buf, len, &line, NULL,
                                               NULL));
    testrun(DTN_HTTP_PARSER_PROGRESS ==
            dtn_http_pointer_parse_status_line((uint8_t *)buf, 0, &line,
                                               &version, NULL));
...
int test_dtn_http_pointer_parse_request_line() {
    ...
    testrun(DTN_HTTP_PARSER_ERROR ==
            dtn_http_pointer_parse_request_line((uint8_t *)buf, len, NULL, NULL,
                                                0, NULL));
    testrun(DTN_HTTP_PARSER_ERROR == dtn_http_pointer_parse_request_line(
                                         NULL, len, &line, NULL, 0, NULL));
    testrun(DTN_HTTP_PARSER_ERROR ==
            dtn_http_pointer_parse_request_line((uint8_t *)buf, len, &line,
                                                NULL, 0, NULL));
    testrun(DTN_HTTP_PARSER_PROGRESS ==
            dtn_http_pointer_parse_request_line((uint8_t *)buf, 0, &line,
                                                &version, 0, NULL));
...
int test_dtn_http_pointer_parse_header_line() {
    ...
    for (size_t i = 0; i < 13; i++) {
        testrun(DTN_HTTP_PARSER_PROGRESS ==
                dtn_http_pointer_parse_header_line((uint8_t *)buf, i, &line, 0,
                                                   NULL));
    }
    ...
    testrun(DTN_HTTP_PARSER_SUCCESS ==
            dtn_http_pointer_parse_header_line((uint8_t *)buf, len, &line, 0,
                                               &next));
    ...
    len = strlen(buf);
    testrun(
        DTN_HTTP_PARSER_PROGRESS ==
        dtn_http_pointer_parse_header_line((uint8_t *)buf, 4, &line, 0, &next));
    testrun(DTN_HTTP_PARSER_ERROR == dtn_http_pointer_parse_header_line(
    ...
    testrun(
        DTN_HTTP_PARSER_PROGRESS ==
        dtn_http_pointer_parse_header_line((uint8_t *)buf, 8, &line, 0, &next));
    testrun(DTN_HTTP_PARSER_SUCCESS ==
            dtn_http_pointer_parse_header_line((uint8_t *)buf, len, &line, 0,
                                               &next));
...
int test_dtn_http_message_create() {
    ...
    dtn_http_message *msg =
        dtn_http_message_create((dtn_http_message_config){0});
    testrun(msg);
...
int test_dtn_http_pointer_parse_message() {
    ...
    testrun(DTN_HTTP_PARSER_ERROR ==
            dtn_http_pointer_parse_message(NULL, NULL));
    testrun(DTN_HTTP_PARSER_ERROR == dtn_http_pointer_parse_message(msg, NULL));
...
int test_dtn_http_create_status() {
    ...
    for (size_t i = 0; i < 2000; i++) {
        ...
        if (i < 100) {
            ...
            testrun(msg);
            testrun(DTN_HTTP_PARSER_SUCCESS ==
                    dtn_http_pointer_parse_status_line(
...
int test_dtn_http_status_not_found() {
    ...
    dtn_http_message *in = dtn_http_create_request_string(
        ...
        (dtn_http_version){.major = 1, .minor = 1}, "method", "uri");
...
int test_dtn_http_create_status_string() {
    ...
    for (size_t i = 0; i < 2000; i++) {
        ...
        if (i < 100) {
            ...
            msg = dtn_http_create_status_string(
                (dtn_http_message_config){0}, (dtn_http_version){0}, i, "test");
...
int test_dtn_http_create_request() {
    ...
    testrun(!dtn_http_create_request(
        (dtn_http_message_config){0}, (dtn_http_version){0},
        (dtn_http_request){.method.start =
                               (uint8_t *)"methodislongerasmaxlength"
                                          "default",
...
int test_dtn_http_create_request_string() {
    ...
    testrun(!dtn_http_create_request_string(
        (dtn_http_message_config){0}, (dtn_http_version){0}, "method", NULL));
...
int test_dtn_http_pointer_parse_comma_list_item() {
    ...
    testrun(!dtn_http_pointer_parse_comma_list_item(NULL, strlen(str), &out,
                                                    &len, &next));
    testrun(!dtn_http_pointer_parse_comma_list_item((uint8_t *)str, 0, &out,
                                                    &len, &next));
...
int test_dtn_http_pointer_find_item_in_comma_list() {
    ...
    testrun(!dtn_http_pointer_find_item_in_comma_list(NULL, len, name, name_len,
                                                      true));
    testrun(!dtn_http_pointer_find_item_in_comma_list(str, 0, name, name_len,
                                                      true));
    testrun(!dtn_http_pointer_find_item_in_comma_list(str, len, NULL, name_len,
                                                      true));
    testrun(!dtn_http_pointer_find_item_in_comma_list(str, len, name, 0, true));

    const uint8_t *out = NULL;
    out = dtn_http_pointer_find_item_in_comma_list(str, len, name, name_len,
                                                   true);
    testrun(out);
    testrun(out == str);
    ...
    testrun(!dtn_http_pointer_find_item_in_comma_list(str, len, name,
                                                      name_len - 1, true));
    testrun(!dtn_http_pointer_find_item_in_comma_list(str, len, name,
                                                      name_len - 1, false));
