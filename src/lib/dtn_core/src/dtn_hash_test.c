...
int test_dtn_hash_function_to_string() {
    ...
    expect = "unspec";
    testrun(0 ==
            strncmp(dtn_hash_function_to_string(0), expect, strlen(expect)));
...
int test_dtn_hash_function_to_RFC8122_string() {
...
int test_dtn_hash_function_from_string() {
    ...
    src = "sha1";
    testrun(DTN_HASH_SHA1 == dtn_hash_function_from_string(src, strlen(src)));
    src = "sha-1";
    testrun(DTN_HASH_SHA1 == dtn_hash_function_from_string(src, strlen(src)));

    src = "sha256";
    testrun(DTN_HASH_SHA256 == dtn_hash_function_from_string(src, strlen(src)));
    src = "sha-256";
    testrun(DTN_HASH_SHA256 == dtn_hash_function_from_string(src, strlen(src)));

    src = "sha512";
    testrun(DTN_HASH_SHA512 == dtn_hash_function_from_string(src, strlen(src)));
    src = "sha-512";
    testrun(DTN_HASH_SHA512 == dtn_hash_function_from_string(src, strlen(src)));
...
int test_dtn_hash_string() {
    uint8_t *src = (uint8_t *)"some test data set to check";
    size_t src_len = strlen((char *)src);
    uint8_t *result = NULL;
    size_t res_size = 0;

    testrun(!dtn_hash_string(DTN_HASH_MD5, NULL, 0, NULL, NULL));
    testrun(!dtn_hash_string(DTN_HASH_MD5, NULL, src_len, &result, &res_size));
    testrun(!dtn_hash_string(DTN_HASH_MD5, src, 0, NULL, &res_size));
    testrun(!dtn_hash_string(DTN_HASH_MD5, src, src_len, &result, NULL));
    testrun(!dtn_hash_string(0, src, src_len, &result, &res_size));

    testrun(dtn_hash_string(DTN_HASH_MD5, src, src_len, &result, &res_size));
    ...
    result = dtn_data_pointer_free(result);
    res_size = 0;
    testrun(dtn_hash_string(DTN_HASH_SHA1, src, src_len, &result, &res_size));
    ...
    result = dtn_data_pointer_free(result);
    res_size = 0;
    testrun(dtn_hash_string(DTN_HASH_SHA256, src, src_len, &result, &res_size));
...
int test_dtn_hash() {
    ...
    testrun(!dtn_hash(DTN_HASH_MD5, NULL, 0, NULL, NULL));
    testrun(!dtn_hash(DTN_HASH_MD5, NULL, 1, &result, &res_size));
    testrun(!dtn_hash(DTN_HASH_MD5, src, 0, NULL, &res_size));
    testrun(!dtn_hash(DTN_HASH_MD5, src, 1, &result, NULL));
    testrun(!dtn_hash(0, src, 1, &result, &res_size));

    testrun(dtn_hash(DTN_HASH_MD5, src, 1, &result, &res_size));
    ...
    testrun(dtn_hash(DTN_HASH_MD5, src, 5, &result, &res_size));
    ...
    testrun(dtn_hash(DTN_HASH_SHA1, src, 1, &result, &res_size));
    ...
    testrun(dtn_hash(DTN_HASH_SHA1, src, 5, &result, &res_size));
    ...
    testrun(dtn_hash(DTN_HASH_SHA256, src, 1, &result, &res_size));
    ...
    testrun(dtn_hash(DTN_HASH_SHA256, src, 5, &result, &res_size));
    ...
    testrun(dtn_hash(DTN_HASH_SHA512, src, 1, &result, &res_size));
    ...
    testrun(dtn_hash(DTN_HASH_SHA512, src, 5, &result, &res_size));
...
int all_tests() {
    ...
    testrun_init();
    testrun_test(test_dtn_hash_function_to_string);
    testrun_test(test_dtn_hash_function_to_RFC8122_string);
    testrun_test(test_dtn_hash_function_from_string);
    testrun_test(test_dtn_hash_function_to_EVP);

    testrun_test(test_dtn_hash_string);
    testrun_test(test_dtn_hash);
