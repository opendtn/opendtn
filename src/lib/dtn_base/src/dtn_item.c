...
dtn_item *dtn_item_object() {
  ...
  dtn_item *item = item_create(
      (dtn_item_config){.literal = dtn_ITEM_OBJECT});
...
bool dtn_item_object_for_each(dtn_item *self,
  ...
  bool result = dtn_dict_for_each(self->config.data, userdata, (void *)function);
...
dtn_item *dtn_item_array() {
  ...
  dtn_item *item = item_create(
      (dtn_item_config){.literal = dtn_ITEM_ARRAY});
...
dtn_item *dtn_item_string(const char *string) {
  ...
  dtn_item *item = item_create(
      (dtn_item_config){.literal = dtn_ITEM_STRING});
...
dtn_item *dtn_item_number(double number) {
  ...
  dtn_item *item = item_create(
      (dtn_item_config){.literal = dtn_ITEM_NUMBER});
...
dtn_item *dtn_item_null() {
  ...
  dtn_item *item = item_create(
      (dtn_item_config){.literal = dtn_ITEM_NULL});
...
dtn_item *dtn_item_true() {
  ...
  dtn_item *item = item_create(
      (dtn_item_config){.literal = dtn_ITEM_TRUE});
...
dtn_item *dtn_item_false() {
  ...
  dtn_item *item = item_create(
      (dtn_item_config){.literal = dtn_ITEM_FALSE});
