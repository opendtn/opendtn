...
static module_output *module_output_create() {
   ...
   */
  mout->func_outputs = dtn_hashtable_create(10,
    (dtn_hashtable_funcs){
      .key_free = free,
...
bool dtn_log_init() {
  ...
  g_default_output.func_outputs = dtn_hashtable_create(100,
    (dtn_hashtable_funcs){
      .key_free = free,
      .key_copy = string_copy,
      .key_cmp = string_compare,
...
static module_output *output_for(char const *module, char const *func) {
  ...
  module_output *mout = dtn_hashtable_get(g_default_output.func_outputs, fname);
