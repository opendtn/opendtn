...
*//**
        ...
        ------------------------------------------------------------------------
*/
#include "../include/dtn_endian.h"

bool dtn_endian_write_uint16_be(uint8_t *buffer, size_t buffer_size,
...
bool dtn_endian_write_uint32_be(uint8_t *buffer, size_t buffer_size,
...
bool dtn_endian_write_uint64_be(uint8_t *buffer, size_t buffer_size,
...
bool dtn_endian_read_uint16_be(const uint8_t *buffer, size_t buffer_size,
                              uint16_t *number) {
...
bool dtn_endian_read_uint32_be(const uint8_t *buffer, size_t buffer_size,
                              uint32_t *number) {
...
bool dtn_endian_read_uint64_be(const uint8_t *buffer, size_t buffer_size,
                              uint64_t *number) {
