...
int test_dtn_uri_string_is_valid() {

  char *string = "http://www.openvocs.org/api?user?auth#password";
  size_t len = strlen(string);

  testrun(!dtn_uri_string_is_valid(NULL, 0));
  testrun(!dtn_uri_string_is_valid(string, 0));
  testrun(!dtn_uri_string_is_valid(NULL, len));

  testrun(dtn_uri_string_is_valid(string, len));

  string = "http://openvocs.org:1234/home?query#fragment";
  testrun(dtn_uri_string_is_valid(string, strlen(string)));
...
int test_dtn_uri_from_string() {

  char *string = "http://www.openvocs.org/api?user?auth#password";
  size_t len = strlen(string);

  testrun(!dtn_uri_from_string(NULL, 0));
  testrun(!dtn_uri_from_string(string, 0));
  testrun(!dtn_uri_from_string(NULL, len));

  dtn_uri *uri = dtn_uri_from_string(string, len);
  testrun(uri);
  ...
  string = "http://openvocs.org:1234/home?query#fragment";
  uri = dtn_uri_from_string(string, strlen(string));
  testrun(uri);
  testrun(0 == strncmp(uri->scheme, "http", 4));
  ...
  string = "user@host:1234/path?query#fragment";
  testrun(!dtn_uri_from_string(string, strlen(string)));
...
int test_dtn_uri_to_string() {
  ...
  testrun(!dtn_uri_to_string(NULL));

  uri = dtn_uri_from_string(string, len);
  testrun(uri);
  out = dtn_uri_to_string(uri);
  testrun(out);
  testrun(0 == strncmp(out, string, strlen(string)));
  out = dtn_data_pointer_free(out);
  uri = dtn_uri_free(uri);
...
int test_dtn_uri_string_is_absolute() {

  char *string = "http://www.openvocs.org/api?user?auth";
  size_t len = strlen(string);

  testrun(!dtn_uri_string_is_absolute(NULL, 0));
  testrun(!dtn_uri_string_is_absolute(string, 0));
  testrun(!dtn_uri_string_is_absolute(NULL, len));

  testrun(dtn_uri_string_is_absolute(string, strlen(string)));
...
int test_dtn_uri_string_is_reference() {

  char *string = "http://www.openvocs.org/api?user?auth#password";
  size_t len = strlen(string);

  testrun(!dtn_uri_string_is_reference(NULL, 0));
  testrun(!dtn_uri_string_is_reference(string, 0));
  testrun(!dtn_uri_string_is_reference(NULL, len));

  testrun(dtn_uri_string_is_reference(string, strlen(string)));
...
int test_dtn_uri_string_length() {
...
int test_dtn_uri_clear() {
  ...
  dtn_uri *uri = dtn_uri_from_string(string, strlen(string));
  testrun(uri);
  testrun(!dtn_uri_clear(NULL));
...
int test_dtn_uri_path_remove_dot_segments() {
  ...
  testrun(!dtn_uri_path_remove_dot_segments(NULL, NULL));
  testrun(!dtn_uri_path_remove_dot_segments(NULL, out));
  testrun(!dtn_uri_path_remove_dot_segments(in, NULL));

  testrun(dtn_uri_path_remove_dot_segments(in, out));
...
int all_tests() {
  ...
  testrun_test(test_dtn_uri_string_is_valid);
  testrun_test(test_dtn_uri_from_string);
  testrun_test(test_dtn_uri_to_string);

  testrun_test(test_dtn_uri_string_is_absolute);
  testrun_test(test_dtn_uri_string_is_reference);

  testrun_test(test_dtn_uri_string_length);
  testrun_test(test_dtn_uri_clear);
  testrun_test(test_dtn_uri_free);

  testrun_test(test_dtn_uri_path_remove_dot_segments);
