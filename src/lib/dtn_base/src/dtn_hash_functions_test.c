/***
        ...
        ------------------------------------------------------------------------
*//**
        @file           dtn_hash_functions_test.c
        @author         Michael Beer
...
int test_dtn_hash_simple_c_string() {

  helper_hash_function_c_string(dtn_hash_simple_c_string, UINT8_MAX / 2);
...
int test_dtn_hash_pearson_c_string() {

  helper_hash_function_c_string(dtn_hash_pearson_c_string, UINT8_MAX / 2);
...
int test_dtn_hash_intptr() {

  for (intptr_t i = 0; i < 0xffff; i++) {

    testrun((uint64_t)i == dtn_hash_intptr((void *)i));
  }
...
int test_dtn_hash_uint64() {

  uint64_t i = 0;

  for (i = 0; i < 0xffff; i++) {

    testrun((uint64_t)i == dtn_hash_uint64(&i));
  }

  // check max
  i = 0xFFFFFFFFFFFFFFFF;
  testrun(i == dtn_hash_uint64(&i));
...
int test_dtn_hash_int64() {

  int64_t i = 0;

  for (i = -0xffff; i < 0xffff; i++) {

    testrun((uint64_t)i == dtn_hash_int64(&i));
  }
...
int all_tests() {
  ...
  testrun_init();
  testrun_test(test_dtn_hash_simple_c_string);
  testrun_test(test_dtn_hash_pearson_c_string);
  testrun_test(test_dtn_hash_intptr);
  testrun_test(test_dtn_hash_uint64);
  testrun_test(test_dtn_hash_int64);
  testrun_test(test_dtn_hash_int64);
