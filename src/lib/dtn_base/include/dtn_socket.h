...
*//**
        ...
        @brief          Definition of a dtn_base socket interface.
...
#define DTN_5TUPLE 2 * DTN_HOST_NAME_MAX + 20
...
/**
        dtn_socket_data may be used to pass the sockaddr_storage,
...
/*
        ...
        format .. ) UDP server socket
                ...
                r = dtn_socket_create( (dtn_socket_configuration) {
...
/**
        Get dtn_socket_config parameter of a socket.
...
/**
        Create dtn_socket_data from a given
        sockaddr_storage
 */
dtn_socket_data
...
bool dtn_socket_disable_nagl(int socket);
bool dtn_socket_disable_delayed_ack(int socket);
...
bool dtn_socket_log(int socket, const char *format, ...);
...
/**
        ...
        @param remote           dtn_socket_date generate of remote using
...
/**
    ...
    Better use dtn_socket_open_server instead.
