...
*//**
        ...
        ------------------------------------------------------------------------
*/
#ifndef dtn_LOG_CONFIG_H
#define dtn_LOG_CONFIG_H
/*----------------------------------------------------------------------------*/
 ...
 *        "dtn_config_log.c" : {
 *
 *            "file" : "/tmp/dtn_config_log.c",
 *            "systemd" : false,
 *            "level" : debug
 *
 *        },
 *
 *        "dtn_ssid_translation_table.c" : {
 *
 *            "sytemd" : true,
 *            "level" : warning,
 *
 *            "functions" : {
 *
 *                "dtn_ssid_translation_table_unlock" : {
 *
 *                    "systemd" true,
 *                    "level" : debug,
 *
 *                },
 *
 *                "dtn_ssid_translation_table_get_empty" : {
 *
 *                    "systemd" true,
 *                    "level" : debug,
 *                    "file" : {
