/***
        ...
        ------------------------------------------------------------------------
*//**
        @file           dtn_event_loop_test_interface.h
        ...
        @brief          Definition of interface tests for dtn_event_loop


        ------------------------------------------------------------------------
*/
#ifndef dtn_event_loop_test_interface_h
#define dtn_event_loop_test_interface_h
...
#endif /* dtn_event_loop_test_interface_h */
