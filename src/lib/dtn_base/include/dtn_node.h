...
*//**
        ...
        @brief          Abstract definition of a double linked list to
                        ...
                        dtn_node MUST be the head of the struct. The new struct
                        will inheritage all node functions, as long as
                        dtn_node is the the head of the new struct.
...
/**
        ...
        custom lists based on dtn_node inheritance.

        @param node     some struct with a first item of kind dtn_node
*/
void *dtn_node_next(void *node);
...
/**
        ...
        at pos out of some custom lists based on dtn_node inheritance.
...
*/
bool dtn_node_set(void **head, uint64_t pos, void *item);
...
/**
        ...
        some custom lists based on dtn_node inheritance.
...
/**
        ...
        @param head     head of the list
*/
bool dtn_node_unplug(void **head, void *node);
...
*/
uint64_t dtn_node_get_position(const void *head, const void *node);
...
/**
        ...
        @param node     node to search
*/
bool dtn_node_is_included(const void *head, const void *node);
...
/**
        ...
        @param node     node to search
*/
bool dtn_node_remove_if_included(void **head, void *node);
...
*/
bool dtn_node_push(void **head, void *node);
...
/**
        ...
        @param node     node to push
*/
bool dtn_node_push_front(void **head, void *node);
...
/**
        ...
        @param head     start of the list
*/
void *dtn_node_pop_first(void **head);
...
*/
bool dtn_node_insert_before(void **head, void *node, void *next);
...
/**
        ...
        @NOTE           this functions checks if prev is part of
                        list at head before doing any changes.
*/
bool dtn_node_insert_after(void **head, void *node, void *prev);
