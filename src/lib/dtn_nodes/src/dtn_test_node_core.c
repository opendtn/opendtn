...
static bool message_bundle_process(dtn_test_node_core *self,
                                   Threadmessage *msg) {
...
static bool message_state_change_process(dtn_test_node_core *self,
                                         Threadmessage *msg) {
...
dtn_test_node_core *
dtn_test_node_core_create(dtn_test_node_core_config config) {
...
dtn_test_node_core *dtn_test_node_core_free(dtn_test_node_core *self) {
    ...
    if (!dtn_test_node_core_cast(self))
        return self;
