...
PACKAGE_LISTS_DIR=${DTN_ROOT}/resources/
PLUGINS_PACKAGE_LISTS_DIR=${DTN_ROOT}/src/plugins/resources/

if [ "X$DTN_ROOT" == "X" ]; then
    echo "DTN_ROOT not set - have you sourced in env.sh?"
    exit 1
fi
